...
import DomReady from 'bento/lib/domready';
import EventSystem from 'bento/eventsystem';
import AssetManager from 'bento/managers/asset';
import InputManager from 'bento/managers/input';
import ObjectManager from 'bento/managers/object';
import AudioManager from 'bento/managers/audio';
import ScreenManager from 'bento/managers/screen';
import SaveState from 'bento/managers/savestate';
import Vector2 from 'bento/math/vector2';
import Rectangle from 'bento/math/rectangle';
import Renderer from 'bento/renderer';
